...
// if suppose there are 1000 components and some 10-20 components are using the same data then we can create a config file and we can export the data from the config file and we can use it in the components where ever we want
...
export {IMG_CDN_URL}; //named export